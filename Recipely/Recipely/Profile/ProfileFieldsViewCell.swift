...
final class ProfileFieldsViewCell: UITableViewCell {
    ...
    private let imageBackground: UIView = {
        ...
        imageBackground.backgroundColor = .backgroundTeal
    ...
    private let lineView: UIView = {
        ...
        lineView.backgroundColor = .deviderLight
        return lineView
    }()
    ...
    func setButtonInformation(text: String, icon: UIImage, handler: @escaping () -> ()) {
